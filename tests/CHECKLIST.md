...
- [x] **V3 消息解析鲁棒性 (Robust Parsing)**: 验证 `formatMessageContent` 能兼容处理 `text`/`content` 多字段、思考块 (thinking/thought/reasoning) 及工具调用渲染。 `2026-04-10`
- [x] **V3 历史递归脱壳**: 验证解析器能自动处理被转义为字符串 JSON 的历史消息 `content`。 `2026-04-10`
